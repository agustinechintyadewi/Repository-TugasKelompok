                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b>Hello Again Pet Lovers!</b></h1>
                                    </div>
                                    <form action="<?php echo e(route('login.action')); ?>" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                          <input name="email" type="email" class="form-control form-control-user" id="inputEmail" aria-describedby="emailHelp" 
                                          placeholder="Masukkan Email Anda">
                                        </div>
                                        <div class="form-group">
                                          <input name="password" type="password" class="form-control form-control-user" id="inputPassword" 
                                      ...
                                      <hr>
                                      <div class="text-center">
                                        <a class="small" href="<?php echo e(route('register')); ?>">Don't Have an Account? Sign Up!</a>
                                      </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH D:\Chintya\KULIAH\SMT 6\PEMWEB\Project\webpetshelter\resources\views/auth/login.blade.php ENDPATH**/ ?>