...
<body>
    ...
    <div class="dashboard-banner2">
        <img src="{{ asset('admin_assets/img/cutecat.jpg') }}">
    </div>
    ...
    <div class="dashboard-card-side">
        <div class="card mb-3" style="max-width: 1250px;">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="{{ asset('admin_assets/img/little-cat-relaxing-outdoors-concept.jpg') }}" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                ...
                <br>
                    <a href="{{ route('toShelter') }}" class="btn btn-dark">Kirim Hewan</a>
        ...
        <div class="dashboard-content">
            ...
            <ul>
                <div class="dashboard-card">
                    <img src="{{ asset('admin_assets/img/close-up-woman-playing-with-cat-sitting-chair.jpg') }}" class="card-image">
                    <div class="card-detail">
                        <h4>{{ $h->nama_hewan }} ({{ $h->umur_hewan }})</h4>
                        <hr color="black">
                        <p> {{ $h->jenis_hewan }}</p>
                        <p><b>Kondisi:</b> {{ $h->deskripsi }}</p>
                        <p><b>Syarat Adopsi:</b> {{ $h->syarat }}</p>
                    </div>
                    <div class="adoptbutton">
                        <a class="btn btn-dark" href="{{ route('toAddopt') }}">Adopsi</a>
                    </div>
                    <br>
                </div>
            </ul>
