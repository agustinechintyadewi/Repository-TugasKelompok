...
<head>
    ...
    <!-- My Style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/css/style2.css') }}">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-10 text-right z-10">
                    <a class="btn btn btn-dark mb-2" href="{{ route('login') }}">Masuk</a>
                    <a class="btn btn btn-dark mb-2" href="{{ route('register') }}">Daftar</a>
                </div>
            </div>
        </div>
    </nav>
